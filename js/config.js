...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    $stateProvider
        ...
        .state('rs', {
            abstract: true,
            url: "/rs",
            templateUrl: "pages/rs/content.html",
            controller: 'RsCtrl'
        })
        ...
        .state('timepicker', {
            url: "/timepicker",
            templateUrl: "pages/timepicker/timepicker.html",
        ...
        .state('forms.file_upload', {
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            files: ['css/plugins/dropzone/basicinfo.css','css/plugins/dropzone/dropzone.css','js/plugins/dropzone/dropzone.js']
                        },
                        {
