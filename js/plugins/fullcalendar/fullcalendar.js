...
// Creates a basicinfo segment with the intersection of the two ranges. Returns undefined if no intersection.
...
$.extend(TimeGrid.prototype, {
	...
	// Renders the basicinfo HTML skeleton for the grid
	renderHtml: function() {
		return '' +
			'<div class="fc-bg">' +
				'<table>' +
...
function View(calendar) {
	...
	// ====================================================================================================
	// The "basicinfo" views are completely made up of day cells.
...
/* An abstract class for the "basicinfo" views, as well as month view. Renders one or more rows of day cells.
----------------------------------------------------------------------------------------------------------------------*/
...
$.extend(BasicView.prototype, {
	...
	render: function(rowCnt, colCnt, dayNumbersVisible) {
		...
		this.el.addClass('fc-basicinfo-view').html(this.renderHtml());
